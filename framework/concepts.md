...
| `specflowctl validate` | Validate candidate spec structure (7 checks), rule validation (6 mechanical checks), or file write permissions | Human maintainer or agent |
